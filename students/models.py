...
class Students(models.Model):
    ...
    email = models.EmailField(help_text='Введите адрес электронной почты.')
    year = models.CharField(max_length=6, choices=YEAR_IN_COLLAGE, verbose_name='Курс')
    enrollment_date = models.DateField(help_text='Дата зачисления.', verbose_name='Дата зачисления')
